...
type ChatV1Client interface {
	...
	SendMessageToChat(ctx context.Context, in *SendMessageRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *chatV1Client) SendMessageToChat(ctx context.Context, in *SendMessageRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/chat_v1.ChatV1/SendMessageToChat", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ChatV1Server interface {
	...
	SendMessageToChat(context.Context, *SendMessageRequest) (*emptypb.Empty, error)
...
func (UnimplementedChatV1Server) SendMessageToChat(context.Context, *SendMessageRequest) (*emptypb.Empty, error) {
...
func _ChatV1_SendMessageToChat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SendMessageRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChatV1Server).SendMessageToChat(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chat_v1.ChatV1/SendMessageToChat",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatV1Server).SendMessageToChat(ctx, req.(*SendMessageRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ChatV1_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ChatV1_SendMessageToChat_Handler,
		},
	},
